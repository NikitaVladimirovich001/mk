...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ['label' => 'Заявки', 'url' => ['proposal/index'], 'linkOptions' => ['class'=>'navbar_li your_custom_class']],
            ['label' => 'Каталог', 'url' => ['catalog/index'], 'linkOptions' => ['class'=>'navbar_li your_custom_class']],
            ['label' => 'Аренда', 'url' => ['rent/index'], 'linkOptions' => ['class'=>'navbar_li your_custom_class']],
            ['label' => 'Категория каталог', 'url' => ['category-catalog/index'], 'linkOptions' => ['class'=>'navbar_li your_custom_class']],
            ['label' => 'Категория аренда', 'url' => ['category-rent/index'], 'linkOptions' => ['class'=>'navbar_li your_custom_class']],
